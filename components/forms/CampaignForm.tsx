...
import { createCampaignAction } from '@/database/drizzle/queries';
    ...
    <div className='flex flex-col items-center'>
      ...
      <form action={formAction} className='w-full max-w-xs flex flex-col gap-2'>
        ...
        <input
          ...
          required
        />
        {getFieldError('campaign_name') && <ErrorToast message={getFieldError('campaign_name')} />}
        ...
        />
        {getFieldError('description') && <ErrorToast message={getFieldError('description')} />}
        <label htmlFor='start_date' className='form-control'>
          start date
        </label>
        <input type='date' name='start_date' className='input input-bordered input-primary' />
        {getFieldError('start_date') && <ErrorToast message={getFieldError('start_date')} />}
        <label htmlFor='end_date' className='form-control'>
          end date
        </label>
        <input type='date' name='end_date' className='input input-bordered input-primary' />
        {getFieldError('end_date') && <ErrorToast message={getFieldError('end_date')} />}
