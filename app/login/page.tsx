    ...
    <div className='flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2'>
      ...
      >
        ...
        <span className='flex flex-col items-center'>
          <button className='btn btn-success w-1/3 rounded-md px-1 py-2 text-foreground mb-4'>
            sign in
          </button>
          <button
            formAction={signUp}
            className='btn btn-secondary w-1/3 rounded-md px-1 py-2 text-foreground mb-2'
          >
            sign up
          </button>
        </span>
